...
// Derives barcode count from ticket fields — falls back to 1 if quantity is absent
          ...
          {Array.from({ length: totalTickets }).map((_, i) => (
            <div key={i} className="min-w-full snap-center px-7">
              <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
                ...
                {/* Barcode graphic */}
                <div className="h-14 w-full overflow-hidden rounded-lg bg-[repeating-linear-gradient(90deg,#1e293b_0px,#1e293b_2px,transparent_2px,transparent_5px),repeating-linear-gradient(90deg,#1e293b_0px,#1e293b_1px,transparent_1px,transparent_8px),repeating-linear-gradient(90deg,#1e293b_0px,#1e293b_3px,transparent_3px,transparent_6px)]" />
                <p className="mt-2 text-center font-mono text-[10px] tracking-widest text-slate-400">
                  {ticketCode}-{String(i + 1).padStart(3, "0")}
                </p>
              </div>
            </div>
          ))}
