...
import { Calendar, Users, TrendingUp, Mail, Plus, Edit2, Trash2, Eye } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#FAFAF8] py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[["Total Events", "3", Calendar, "indigo"], ["Total Attendees", "950", Users, "amber"], ["Total Revenue", "$12.7K", TrendingUp, "green"], ["Avg Rating", "4.8★", Mail, "purple"]].map(([label, value, Icon, color]: any) => (
