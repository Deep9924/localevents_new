...
export default function EventCard({ 
  ...
  return (
    <div onClick={handleCardClick} className={cn("group cursor-pointer flex flex-col", className)}>
      <div className="relative overflow-hidden rounded-2xl bg-gray-100" style={{ aspectRatio: "16/9" }}>
        ...
        {event.isFeatured && (
          <Badge className="absolute top-2.5 left-2.5 bg-amber-50 text-amber-900 border border-amber-100 font-semibold px-2.5 py-1 rounded-full">
            <span className="text-amber-400 mr-1">★</span> Featured
          </Badge>
        )}
