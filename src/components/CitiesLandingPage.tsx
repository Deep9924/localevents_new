      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        {Object.entries(byCountry)
          .sort(([a], [b]) => {
            ...
            if (["United States", "US", "USA"].includes(a)) return -1;
            if (["United States", "US", "USA"].includes(b)) return 1;
                ...
                {countryCities.map((city: City) => (
                  ...
                  >
                    <div className="min-w-0">
                      <h3
                        className="text-sm font-bold text-gray-900 group-hover:text-indigo-600 transition-colors truncate"
                        style={{ fontFamily: "'Sora', sans-serif" }}
                      >
                        {city.name}
                      </h3>
